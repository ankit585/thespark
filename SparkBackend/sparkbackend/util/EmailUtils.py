...
class EmailUtils:
    ...
    def sendRegistrationMail(
        ...
        url = 'http://96.126.100.154/api/v1/user/confirmation?id=' \
            + str(userKey) + '&code=' + code
...
''' \
            + url
        html = '<html><head></head><body><p>Hi ' + firstName \
            + '<br>Welcome to The Spark.Please confirm your registration by clicking the following link.<br>' \
            + url + '</p></body></html>'
